...
### ✅ 已完成
- **TTS 语音播报功能 CI 全绿**：commit `e7b8cb67` 的 CI 运行 #31489167800 成功（6m16s）。TtsManager + Settings + ViewModel + UI 喇叭按钮 + 设置页全部编译通过。
...
- [x] TTS 语音播报功能：TtsManager + Settings + ViewModel + UI 喇叭按钮 + 设置页。CI 全绿验证通过（#31489167800 ✓）。
